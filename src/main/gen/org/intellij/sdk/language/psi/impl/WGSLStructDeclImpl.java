...
public class WGSLStructDeclImpl extends ASTWrapperPsiElement implements WGSLStructDecl {

  public WGSLStructDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WGSLStructBodyDecl getStructBodyDecl() {
    return findNotNullChildByClass(WGSLStructBodyDecl.class);
  }
