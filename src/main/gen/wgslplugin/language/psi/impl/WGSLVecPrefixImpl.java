...
public class WGSLVecPrefixImpl extends ASTWrapperPsiElement implements WGSLVecPrefix {

  public WGSLVecPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WGSLVisitor visitor) {
    visitor.visitVecPrefix(this);
  }
