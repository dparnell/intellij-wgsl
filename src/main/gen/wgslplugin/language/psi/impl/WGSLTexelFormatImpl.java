...
public class WGSLTexelFormatImpl extends ASTWrapperPsiElement implements WGSLTexelFormat {

  public WGSLTexelFormatImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WGSLVisitor visitor) {
    visitor.visitTexelFormat(this);
  }
