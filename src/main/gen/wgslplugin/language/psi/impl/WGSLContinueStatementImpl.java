...
public class WGSLContinueStatementImpl extends ASTWrapperPsiElement implements WGSLContinueStatement {

  public WGSLContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
