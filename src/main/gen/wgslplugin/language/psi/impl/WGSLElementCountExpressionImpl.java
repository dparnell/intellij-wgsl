...
public class WGSLElementCountExpressionImpl extends ASTWrapperPsiElement implements WGSLElementCountExpression {

  public WGSLElementCountExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WGSLVisitor visitor) {
    visitor.visitElementCountExpression(this);
  }
